...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info("Data transformation file initiated")
            ...
            logging.info("Data transformation file completed")
    ...
    def initiate_data_transformation(self,train_data_path,test_data_path):
        ...
        try:
            ...
            # dividing the datasset into independent & dependent features
            # training data
            ...
            logging.info("Applying data transformation on train & test datasets.")
